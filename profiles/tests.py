...
class ProfileTestCase(TestCase):
    def setUp(self):
        self.user = User.objects.create_user(username='nii', password='comeandsee')
        self.userb = User.objects.create_user(username='naa', password='Jesus')
    
    def get_client(self):
        client = APIClient()
        client.login(username=self.user.username, password='comeandseeJesus')
        return client
